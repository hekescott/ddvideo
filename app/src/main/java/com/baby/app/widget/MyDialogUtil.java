...
public class MyDialogUtil {
     ...
     * 弹出公告
     */
    public static void showAnnounceMentDialog(Context mContext, String title, String message, String NoticeBrief) {
        AnnouncementDialog.Builder builder = new AnnouncementDialog.Builder(mContext);
        final AnnouncementDialog mDialog = builder.setTitle(title)
                .setMessage(message).setNoticeBrief(NoticeBrief).create();
        mDialog.show();
    }
