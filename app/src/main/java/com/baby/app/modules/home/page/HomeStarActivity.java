...
public class HomeStarActivity extends IBaseActivity implements StarListView,
    ...
    public static void startHomeStar() {
        ActivityUtil.navigateTo(HomeStarActivity.class);
    }
    ...
    private void initTopRecycleView() {
        ...
        mStarTopClassAdapter = new ClassTopAdapter(R.layout.item_class_top_layout,
                topClassBeanList);
    ...
    private void initMoreClassRecycleView() {
        ...
        mStarMoreClassAdapter = new ClassTopAdapter(R.layout.item_class_top_layout,
                moreClassBeanList);
