...
public class PromoteTypeAdapter extends BaseMultiItemQuickAdapter<PromoteBean, BaseViewHolder> {
    ...
    private PromoteNumBean promoteNumBean;
     ...
     */
    public PromoteTypeAdapter(List<PromoteBean> data, Context mContext, PromoteNumBean promoteNumBean) {
        super(data);
        this.promoteBeans = data;
        this.promoteNumBean = promoteNumBean;
        //福利任务数据
...
//        fuliBean1.setIsBottomHidden(false);
        ...
        if (promoteNumBean != null) {
            fuliBean2.setSpanned(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">手机号注册，每日观影次数</font>" +
                    "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getPhoneReg() + "</font>" +
            ...
            fuliBean3.setSpanned(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">注册并填写好友邀请码，每日观影次数</font>" +
                    "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getRegCode() + "</font>"));
            ...
            fuliBean4.setSpanned(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">保存推广二维码，每日观影次数</font>" +
                    "<font size=\"14\" color=\"#FD0000\">+1</font>"));
...
//                }
                ...
                inviteView.setText(UserStorage.getInstance().getExtensionCode());
                erBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mPromoteTypeAdapterLisenter != null) {
...
//                RelativeLayout right_view_1 = helper.getView(R.id.right_view_1);
                View right_view_2 = helper.getView(R.id.right_view_2);
            ...
            case PromoteBean.PROMOT_ROW3: {
                ...
                if (promoteNumBean != null) {
                    p_task_msg_view.setText(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">每日点击广告</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getAd() + "</font>" +
            ...
            case PromoteBean.PROMOT_ROW4: {
                ...
                if (promoteNumBean != null) {
                    pl_v1_text_view.setText(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">推广</font>" +
                            "<font size=\"14\" color=\"#FD0000\">" + promoteNumBean.getData().getPerson0() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">人-每日观影次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getViewNum0() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">，缓存次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getCacheNum0() + "</font>"));
                    ...
                    pl_v2_text_view.setText(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">推广</font>" +
                            "<font size=\"14\" color=\"#FD0000\">" + promoteNumBean.getData().getPerson1() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">人-每日观影次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getViewNum1() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">，缓存次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getCacheNum1() + "</font>"));
                    ...
                    pl_v3_text_view.setText(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">推广</font>" +
                            "<font size=\"14\" color=\"#FD0000\">" + promoteNumBean.getData().getPerson2() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">人-每日观影次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getViewNum2() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">，缓存次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getCacheNum2() + "</font>"));
                    ...
                    pl_v4_text_view.setText(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">推广</font>" +
                            "<font size=\"14\" color=\"#FD0000\">" + promoteNumBean.getData().getPerson3() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">人-每日观影次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getViewNum3() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">，缓存次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getCacheNum3() + "</font>"));
                    ...
                    pl_v5_text_view.setText(Html.fromHtml("<font size=\"14\" color=\"#6e6e6e\">推广</font>" +
                            "<font size=\"14\" color=\"#FD0000\">" + promoteNumBean.getData().getPerson4() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">人-每日观影次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getViewNum4() + "</font>" +
                            "<font size=\"14\" color=\"#6e6e6e\">，缓存次数</font>" +
                            "<font size=\"14\" color=\"#FD0000\">+" + promoteNumBean.getData().getCacheNum4() + "</font>"));
                }
            }
            break;
            case PromoteBean.PROMOT_ROW5: {
