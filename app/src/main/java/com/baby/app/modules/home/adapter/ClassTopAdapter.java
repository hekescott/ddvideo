    ...
    protected void convert(BaseViewHolder helper, final HomeClassBean item) {
       ...
       TextView nameView = helper.getView(R.id.top_class_name_view);
        ...
        if (item.getName().equals(name)) {
            ...
            helper.getView(R.id.top_class_back_view).setBackgroundResource(R.drawable.tag_corner2_selected);
        } else {
            nameView.setSelected(false);
            helper.getView(R.id.top_class_back_view).setBackgroundResource(R.drawable.tag_corner2_unselected);
        }
