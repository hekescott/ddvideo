...
public class VipAdapter extends BaseQuickAdapter<VipBean.Data, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, final VipBean.Data item) {
        ...
        switch (item.getCardType()) {
            case 1:
                imageView.setBackgroundResource(R.mipmap.card_day);
                break;
            case 30:
                imageView.setBackgroundResource(R.mipmap.card_month);
                break;
            case 90:
                imageView.setBackgroundResource(R.mipmap.card_season);
                break;
            case 365:
                imageView.setBackgroundResource(R.mipmap.card_year);
                break;
            default:
                break;
        }
