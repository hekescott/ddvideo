...
public class FindFragment extends IBaseFragment implements SwipeRefreshLayout.OnRefreshListener,
        BaseQuickAdapter.RequestLoadMoreListener, FindView {
    ...
    public void initUiAndListener(View view) {
        ...
        mFindAdapter.setmFindAdapterLisenter(new FindAdapter.FindAdapterLisenter() {
            ...
            public void onShare(FindBean.Data findBean) {
                if (mFindBean != null) {
                    @SuppressLint("WrongConstant") ClipboardManager cm =
...
//        mTitleBuilder.seTitleBgColor(ResourceUtil.getColor(R.color.colorPrimaryDark));
        mTitleBuilder.setMiddleTitleText("发现").setMiddleTitleTextColor(ResourceUtil.getColor(R.color.white)).setRightImageRes(R.mipmap.search_white);
    }
