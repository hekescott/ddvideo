...
public class ChannelTagActivity extends IBaseActivity implements ChannelView {
    ...
    public void initToolBar(TitleBuilder mTitleBuilder) {
        mTitleBuilder.setMiddleTitleText("标签筛选")
                .setLeftDrawable(R.mipmap.icon_title_back_white).setRightText("确定").setRightTextColor(Color.parseColor("#FFFFFFFF"));
    }
    ...
    private void initLeftRecycleView() {
        ...
        mTagLeftAdapter = new TagTopAdapter(R.layout.item_tag_left_layout, tagClassBeanList);
