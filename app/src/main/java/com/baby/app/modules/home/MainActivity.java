...
//                    }
    ...
    private void requestPermission() {
         ...
         * 请求所有必要的权限----
         */
        HPermissions.getInstance().requestAllManifestPermissionsIfNecessary(this,
        ...
        if (UserStorage.getInstance().getUser() != null && UserStorage.getInstance().getUser().getNoticeList() != null) {
            ...
            if (noticeList != null && noticeList.size() > 0) {
                for (int i = 0; i < noticeList.size(); i++) {
                    ...
                    MyDialogUtil.showAnnounceMentDialog(this, notice.getNoticleTitle(),
                            notice.getNoticContent(), notice.getNoticeBrief());
                }
            }
        }
    ...
    private void changeRadioButtonStatu(int currSel) {
        switch (currSel) {
            case 0:
                ...
                image_4.setBackgroundResource(R.mipmap.n_center);
        ...
        switch (currSel) {
            ...
            case 1:
                if (mChannelFragment == null) {
                    ...
                    mTransaction.add(R.id.fragment_container, mChannelFragment,
                            ChannelFragment.TAG);
                } else {
