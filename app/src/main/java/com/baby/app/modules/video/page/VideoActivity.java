...
public class VideoActivity extends IBaseActivity implements IVideoView {
    ...
    public static void startVideo(int id, String name, String url) {
        ...
        ActivityUtil.navigateTo(VideoActivity.class, bundle);
    }
...
//        mTitleBuilder.setMiddleTitleText("").setMiddleTitleTextColor(Color.parseColor
//        ("#FFFFFFFF")).setLeftDrawable(R.mipmap.ic_white_brown);
    }
    ...
    public void initUiAndListener() {
        ...
        video_comment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (UserStorage.getInstance().getSortNo() >= 2 || UserStorage.getInstance().getIsVip() == 1) {
                    Bundle bundle = new Bundle();
                    bundle.putString(Constants.KEY_INTENT_ACTIVITY,
                    ...
                    MyDialogUtil.showCommonDialogDialog(VideoActivity.this, "用户等级2" +
                            "级才可发表评论，邀请好友就可以升级啦！", new CommonDialog.CommonDialogLisenter() {
                        @Override
                        public void onClick() {
        ...
        play_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MyDialogUtil.showCommonDialogDialog(VideoActivity.this,
                        "今日的观影次数已耗尽，邀请好友就获得更多观影次数啦", new CommonDialog.CommonDialogLisenter() {
                            @Override
                            public void onClick() {
                                openActivity(ErActivity.class);
                                finish();
    ...
    public void refreshDetail(VideoDetailBean videoDetailBean) {
        ...
        if (mVideoInComeBean.getIsCache() == 0) {
            if (mVideoDetailBean.getUseView() != null && mVideoDetailBean.getUseView().equals("1")) {
                ...
                String cache = (String) getIntent().getStringExtra("c");
                if (cache != null && cache.equals("1")) {
                    mJzvdStd.setUp(mVideoDetailBean.getData().getVideoUrl(),
                            mVideoDetailBean.getData().getVideoName()
                            , JzvdStd.SCREEN_WINDOW_FULLSCREEN);
...
//        }
                ...
                videoRelease();
                MyDialogUtil.showCommonDialogDialog(this, "今日的观影次数已耗尽，邀请好友就获得更多观影次数啦",
                        new CommonDialog.CommonDialogLisenter() {
                            @Override
                            public void onClick() {
                                openActivity(ErActivity.class);
                                finish();
...
//            });
            ...
            if (bannerBean.getPicUrl() != null && !bannerBean.getPicUrl().equals("")) {
                editor.putString("logoUrl", bannerBean.getPicUrl());
            } else {
                editor.putString("logoUrl", "");
            }
            editor.commit();
            mJzvdStd.setBannerImg();
        }
        ...
        mVideoTypeAdapter.setmVideoTypeAdapterLisenter(new VideoTypeAdapter.VideoTypeAdapterLisenter() {
            ...
            //点赞
            public void setZan() {
                mVideoPresenter.setCareTimes(String.valueOf(mVideoDetailBean.getData().getId()),
                        "1");
            }
            ...
            public void onStarListClick(HomeListBean homeListBean) {
                videoRelease();
                finish();
                jumpToVideo(homeListBean.getId(), homeListBean.getVideoName(),
                        homeListBean.getVideoUrl());
    ...
    public void isCanDown() {
        startDownLoad(mVideoDetailBean.getData().getVideoUrl()
                , mVideoDetailBean.getData().getVideoName(),
                mVideoDetailBean.getData().getVideoCover(),
                String.valueOf(mVideoDetailBean.getData().getId()));
    }

    @Override
    public void onCacheFailed() {
        MyDialogUtil.showCommonDialogDialog(this, "今日的缓存次数已耗尽，邀请好友就获得更多观影次数啦",
                new CommonDialog.CommonDialogLisenter() {
                    @Override
                    public void onClick() {
                        openActivity(ErActivity.class);
        ...
        onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                try {
                    ...
                    statusBarHeight =
                            getApplicationContext().getResources().getDimensionPixelSize(x);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                if (visible && visible != isVisiableForLast) {
                    ...
                    RelativeLayout.LayoutParams layoutParams =
                            (RelativeLayout.LayoutParams) videoChatBackView.getLayoutParams();
                    if (Build.BRAND.toLowerCase().contains("huawei") || Build.MANUFACTURER.equals("Huawei") || Build.BRAND.toLowerCase().contains("honor")) {
                        layoutParams.bottomMargin =
                                keyboardHeight + ScreenUtil.dip2px(VideoActivity.this, 10);
                    } else {
                        layoutParams.bottomMargin =
                                keyboardHeight + ScreenUtil.dip2px(VideoActivity.this, 30);
                    }
