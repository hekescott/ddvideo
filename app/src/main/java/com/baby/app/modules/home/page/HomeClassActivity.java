...
import com.baby.app.modules.home.adapter.ClassTopTitleAdapter;
...
public class HomeClassActivity extends IBaseActivity implements DetailListView,
    ...
    private ClassTopTitleAdapter mHomeTopClassAdapter;
...
//        mTitleBuilder.seTitleBgColor(Color.parseColor("#FF000000"));
        ...
        mTitleBuilder.setMiddleTitleText("分类").setLeftImageViewEnabled(true).setRightImageRes(R.mipmap.search_white);
//        mTitleBuilder.setMiddleTitleTextColor(Color.parseColor("#FFFFFFFF"));
    ...
    public void initUiAndListener() {
        ...
        if (beforeType == 1) {
            beforeClassBean =
                    (HomeClassBean) getIntent().getExtras().getSerializable(HOME_CLASS_KEY);
            mostType = 1;
    ...
    private void initTopRecycleView() {
        ...
        mHomeTopClassAdapter = new ClassTopTitleAdapter(R.layout.item_class_top_layout1,
                topClassBeanList);
        ...
        mHomeTopClassAdapter.setClassTopAdapterLisenter(new ClassTopTitleAdapter.ClassTopAdapterLisenter() {
            @Override
...
//                * mostPlay 最多播放
    ...
    private void initMoreClassRecycleView() {
        ...
        mHomeMoreClassAdapter = new ClassTopAdapter(R.layout.item_class_top_layout,
                moreClassBeanList);
        if (beforeType == 2) {
        ...
        classListAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (dataArrayList.size() > 0) {
                    ...
                    jumpToVideo(detailListBean.getId(), detailListBean.getVideoName(),
                            detailListBean.getVideoUrl());
                }
