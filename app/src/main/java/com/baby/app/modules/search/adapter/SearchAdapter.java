package com.baby.app.modules.search.adapter;
...
public class SearchAdapter extends BaseQuickAdapter<DetailListBean.Data,BaseViewHolder> {
    public SearchAdapter(int layoutResId, @Nullable List<DetailListBean.Data> data) {
...
//        tag4.setVisibility(View.INVISIBLE);
        ...
        video_count_view.setText(item.getPlayNum()+"次播放");
