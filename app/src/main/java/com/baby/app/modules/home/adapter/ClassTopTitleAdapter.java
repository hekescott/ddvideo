...
public class ClassTopTitleAdapter extends BaseQuickAdapter<HomeClassBean,BaseViewHolder> {
    ...
    public ClassTopTitleAdapter(int layoutResId, @Nullable List<HomeClassBean> data) {
    ...
    protected void convert(BaseViewHolder helper, final HomeClassBean item) {
       ...
       TextView nameView = helper.getView(R.id.top_class_name_view);
        ...
        if (item.getName().equals(name)) {
            ...
            helper.getView(R.id.top_class_back_imageview).setBackgroundResource(R.mipmap.top_title_bg);
        } else {
            nameView.setSelected(false);
            helper.getView(R.id.top_class_back_imageview).setBackground(null);
        }
