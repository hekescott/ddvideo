...
public class JzvdStd extends Jzvd {
    ...
    private ImageView mute_img_btn;
    ...
    public void init(Context context) {
        super.init(context);
        mContext = context;
        bannerImageView = findViewById(R.id.banner_img);
...
//        bottomProgressBar = findViewById(R.id.bottom_progress);
        ...
        mute_img_btn = findViewById(R.id.mute_img_btn);
        ...
        mute_btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                isMute = !isMute;
                if (isMute) {
                    mute_img_btn.setImageResource(R.drawable.volume_close);
                    setMuteZero();
                } else {
                    mute_img_btn.setImageResource(R.drawable.volume_open);
                    setMuteZeroOpen();
                }
            }
        });
...
//                mute_btn.setVisibility(VISIBLE);
            }
        }, 1000);
    ...
    public void setBannerImg() {
        ...
        String picUrl=sharedPreferences.getString("logoUrl","");
...
//        titleTextView.setText(jzDataSource.title);
    ...
    private boolean isOnStatePlaying = true;
...
//        bottomProgressBar.setSecondaryProgress(0);
    ...
    @Override
    public void startVideoFirst() {
        super.startVideoFirst();
        if (fisrtLoad) {
            fisrtLoad = false;
            loadingProgressBar.setVisibility(VISIBLE);
        }
...
//        mute_btn.setVisibility(topCon);
        bottomContainer.setVisibility(bottomCon);
        startButton.setVisibility(startBtn);
        thumbImageView.setVisibility(thumbImg);
//        loadingProgressBar.setVisibility(bottomPro);
    ...
    public void dissmissControlView() {
        if (currentState != CURRENT_STATE_NORMAL
            ...
            post(new Runnable() {
                @Override
                public void run() {
//                    mute_btn.setVisibility(INVISIBLE);
