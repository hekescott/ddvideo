...
public class ImagePreviewFragment extends Fragment{
    ...
    private static ImagePresenter mImagePresenter;//interface to load image,you can implements it with your own code
    ...
    public static class SinglePreviewFragment extends Fragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            ((GlideImagePresenter)mImagePresenter).onPresentImage(imageView, url, imageView.getWidth());//display the image with your own ImageLoader
