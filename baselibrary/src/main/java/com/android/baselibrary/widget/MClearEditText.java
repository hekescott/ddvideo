 ...
 */
public class MClearEditText extends androidx.appcompat.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void setDrawable(Context context) {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable =  ContextCompat.getDrawable(context, R.mipmap.icon_clear_edit);
        }
