package com.android.baselibrary.widget.pageindicator;
...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private final int COLOR_TEXT_NORMAL = 0x77FFFFFF;
    private final int COLOR_TEXT_HIGHLIGHT = 0xFFFFFFFF;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ViewPagerIndicatorTriangle);

        mTabVisibleCount = a.getInt(
                R.styleable.ViewPagerIndicatorTriangle_visible_tab_count,
                COUNT_DEFAULT_TAB);
