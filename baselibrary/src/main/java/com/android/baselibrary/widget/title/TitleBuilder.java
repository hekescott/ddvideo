...
public class TitleBuilder implements View.OnClickListener {
    ...
    public void initBar(View titleView) {
        ...
        mTitleLeftRelativeLayout =
                (RelativeLayout) mTitleView.findViewById(R.id.left_relative_layout);
        mTitleMiddleRelativeLayout =
                (RelativeLayout) mTitleView.findViewById(R.id.mid_relative_layout);
        mTitleRightRelativeLayout =
                (RelativeLayout) mTitleView.findViewById(R.id.right_relative_layout);
        ...
        //RelativeLayout.LayoutParams rl = (RelativeLayout.LayoutParams) mRootView
        // .getLayoutParams();//面板没有全屏
...
//        mTitleLeftRelativeLayout = (RelativeLayout) mTitleView.findViewById(R.id
//        .left_relative_layout);
//        mTitleMiddleRelativeLayout = (RelativeLayout) mTitleView.findViewById(R.id
//        .mid_relative_layout);
//        mTitleRightRelativeLayout = (RelativeLayout) mTitleView.findViewById(R.id
//        .right_relative_layout);
        mTitleLeftImageView = (ImageView) mTitleView.findViewById(R.id.left_icon_title);
        mTitleLeftTextView = (TextView) mTitleView.findViewById(R.id.left_btn);
        mTitleMiddleTextView = (TextView) mTitleView.findViewById(R.id.middle_text);
        mTitleRightTextView = (TextView) mTitleView.findViewById(R.id.title_right_text);
...
//        mTitleLeftTextView.setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
    ...
    public TitleBuilder setLeftImageViewEnabled(boolean enabled) {
        mTitleLeftImageView.setVisibility(enabled ? View.VISIBLE : View.GONE);
        return this;
    }
    ...
    public TextView getMiddleTextView() {
        ...
        return (mTitleMiddleTextView.getVisibility() == View.GONE) ? mSubTitleTextView :
                mTitleMiddleTextView;
    }
