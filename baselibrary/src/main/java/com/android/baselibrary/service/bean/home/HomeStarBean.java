...
public class HomeStarBean extends BaseBean implements Serializable {
    ...
    private List<DetailListBean.Data> starVideoList;

    public List<DetailListBean.Data> getStarVideoList() {
        return starVideoList;
    }

    public void setStarVideoList(List<DetailListBean.Data> starVideoList) {
