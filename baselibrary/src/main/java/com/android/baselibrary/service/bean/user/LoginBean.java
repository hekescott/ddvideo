...
//        this.viewNum = viewNum;
    ...
    public class LinkUrlBean {
        ...
        public String getIosSchame() {
            return iosSchame;
        }

        public void setIosSchame(String iosSchame) {
            this.iosSchame = iosSchame;
        }
        ...
        public String getAndroidSchame() {
            return androidSchame;
        }

        public void setAndroidSchame(String androidSchame) {
            this.androidSchame = androidSchame;
        }

        /**
         * iosUrl : itms-services:///?action=download-manifest&url=https://baitu0.app/download/ios/ios.plist
         * iosSchame : name://
         * androidUrl : https://baitu0.app/download/android/baitushiping.apk
         * androidSchame : weixin://
         */

        public String iosUrl;
        public String iosSchame;
        public String androidUrl;
        public String androidSchame;
