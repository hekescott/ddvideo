...
public class UserStorage {
    ...
    private HomeDataBean.AnhaoMapBean anhao;
    ...
    public List<BottomAdvBean> getBottomAdv() {
        if (info != null && info.getData() != null) {
            bottomAdv = info.getData().getBottomAdv();
        } else {
            bottomAdv = new ArrayList<>();
        }
        return bottomAdv;
    ...
    public void saveAnhaoInfo(HomeDataBean.AnhaoMapBean anhao) {
        this.anhao = anhao;
        SPUtils.putObject(Constants.SP_ANHAO_OBJECT, anhao);
    }
